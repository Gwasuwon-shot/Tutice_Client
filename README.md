...
<img width="250" height="240" src="https://github.com/Gwasuwon-shot/Tutice_Client/assets/100409061/d9ba9eb3-fbbc-4e11-9ebc-59ea2ec19f56"/>

<b> 쉬운 수업 관리로 열리는 정확한 나의 결실 <br/>과외의 출결 체크부터 수업비 관리까지 한번의 클릭으로 쉽게 관리하세요. </b> <br />
...
- 수업 일시 <b>예외 케이스 처리 </b><br/>
	...
	| 상황 | 비활성 버튼 |
	| --- | --- |
	| 조건문을 통해 시간 및 종료 시간을 모두 입력하지 않았을 때 | 수업 일시 추가 |
	| 시간만 입력하고 요일은 입력하지 않은 경우 | 수업 일시 추가 |
	| 요일을 선택할 때, 시작, 종료 시간을 입력하지 않은 경우 | 모든 버튼 |
	| 첫 수업일에 해당하는 요일이 선택한 수업 일시 요일에 해당하지 않는 경우 | 저장 |
...
- 푸쉬 알림을 상대가 허용하지 않았을 시에 <b>경고 모달</b> <br>
- 출결 <b>알림</b>
...
- PWA 환경에서 일반 네이티브 앱과 동일하게 푸시 알림 가능.
<br/>
